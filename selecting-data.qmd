...
My approach to selecting data is to take 400 km^2 grid of the UK and select the landsat
data for each month over the last year that has the least cloud cover. 
